    ...
    run(system) {
        ...
        for (let fC of foundEntityTypeComponents[0]) {
            ...
            if (!isDogInPlayerRadius) {
                ...
                system.setState(this.targetPositionKey, new Utils.Vector2(closestPlayerPositionComponent.x, closestPlayerPositionComponent.y));
            }
            // random movement
            if (isDogInPlayerRadius) {
            ...
            if (targetPosition.y - dogPositionComponent.y > 1)
                direction.y += 1;
            else if (targetPosition.y - dogPositionComponent.y < 1)
                direction.y -= 1;
            if (targetPosition.x - dogPositionComponent.x > 1)
                direction.x += 1;
            else if (targetPosition.x - dogPositionComponent.x < 1)
                direction.x -= 1;
            ...
            if (Math.abs(targetPosition.x - resultDogPosition.x) < 2 &&
